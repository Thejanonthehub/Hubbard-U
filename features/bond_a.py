...
class BondAnalyzer2:
    def __init__(self, cif_file=None, structure=None, tolerance=0.4, n_shortest=4):
        ...
        self.predefined_radii = {
            "Ce": 185.0, "Pr": 185.0, "Nd": 185.0, "Pm": 185.0, "Sm": 180.4, "Eu": 185.0, "Gd": 179.0, "Tb": 175.0,
            "Dy": 178.0, "Ho": 226.0, "Er": 175.0, "Tm": 175.0, "Yb": 175.0, "Lu": 173.8, "Ac": 195.0,
            "Th": 180.0, "Pa": 243.0, "U": 175.0, "Np": 175.0, "Pu": 151.0, "Am": 174.0, "Cm": 174.0, "Bk": 244.0,
            "Cf": 186.0, "Es": 245.0, "Fm": 290.0, "Md": 204.0, "No": None, "Lr": 171.0
        }
    ...
    def _generate_bonds(self):
        ...
        for i, j in itertools.combinations(range(len(self.struct)), 2):
            ...
            if r_i is None:
                sym_i = el_i.symbol
                r_i = self.predefined_radii[sym_i] 
            if r_j is None:
                sym_j = el_j.symbol
                r_j = self.predefined_radii[sym_j] 
            
            #print(f"{el_i.symbol} and {el_j.symbol} have {(r_i + r_j)/100} ==> d is {d}")
            if d <= (((r_i + r_j)/100) + self.tolerance):
                # Determine bond type
